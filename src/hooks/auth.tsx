...
function AuthProvider({children}: AuthProviderProps){
    ...
    const localStorageKey = "@gofinance:User"
    ...
    async function signInWithGoogle() {
        try {
            ...
            if(type === 'success' ){
                ...
                setUser(userLogged)
                await AsyncStorage.setItem(localStorageKey, JSON.stringify(userLogged));
            }
        } catch (error) {
    ...
    useEffect(() => {
        async function loadUserAsyncStorage() {
            const userStoraged = await AsyncStorage.getItem(localStorageKey)
